...
class _BoardViewState extends State<BoardView> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
        Image.asset('asset/image/full_ori.png'),
        Padding(
          padding:  EdgeInsets.only(bottom: MediaQuery.of(context).size.width * 0.009, right:  MediaQuery.of(context).size.width * 0.01),
          child: Container(
            width: MediaQuery.of(context).size.width * 0.538,
            height: MediaQuery.of(context).size.width * 0.538,
            ...
            children: [
              Padding(
                ...
                child: Padding(
                  ...
                  child: Text(
                    "+${luck.value}",
                    style: TextStyle(color: Color(0xffFF2152), fontWeight: FontWeight.bold, fontSize: 18),
                  ),
                ),
              ),
